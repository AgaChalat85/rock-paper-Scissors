package com.kodilla.rockpaperscissorsgame.validation;

import static com.kodilla.rockpaperscissorsgame.enums.CommandEnum.*;
import static com.kodilla.rockpaperscissorsgame.enums.ConfirmationEnum.*;

import com.kodilla.rockpaperscissorsgame.enums.CommandEnum;
import com.kodilla.rockpaperscissorsgame.game.GameWarnings;
...
public class InputValidation {
   ...
   public static ValidationResponse validatePlayerMove(String playerMove) {
       CommandEnum move = CommandEnum.findByMoveButton(playerMove.trim());
       boolean valid = true;
       String warning = null;
